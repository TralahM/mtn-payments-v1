...
from mtn_payments_v1 import MtnPaymentsV1, AsyncMtnPaymentsV1, APIResponseValidationError
from mtn_payments_v1._types import Omit
from mtn_payments_v1._models import BaseModel, FinalRequestOptions
from mtn_payments_v1._constants import RAW_RESPONSE_HEADER
from mtn_payments_v1._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from mtn_payments_v1._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MtnPaymentsV1 | AsyncMtnPaymentsV1) -> int:
...
class TestMtnPaymentsV1:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mtn_payments_v1/_legacy_response.py",
                        "mtn_payments_v1/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mtn_payments_v1/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: MtnPaymentsV1) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MTN_PAYMENTS_V1_BASE_URL="http://localhost:5000/from/env"):
            client = MtnPaymentsV1(client_id=client_id, client_secret=client_secret, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: MtnPaymentsV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MtnPaymentsV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MtnPaymentsV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("mtn_payments_v1._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: MtnPaymentsV1, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMtnPaymentsV1:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMtnPaymentsV1) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncMtnPaymentsV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMtnPaymentsV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMtnPaymentsV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMtnPaymentsV1(
            base_url=base_url, client_id=client_id, client_secret=client_secret, _strict_response_validation=True
        )
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncMtnPaymentsV1,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMtnPaymentsV1, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from mtn_payments_v1._utils import asyncify
        from mtn_payments_v1._base_client import get_platform 
